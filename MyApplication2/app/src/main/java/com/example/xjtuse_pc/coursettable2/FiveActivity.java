...
public class FiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("传过来的课表是"+CourseMap);
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            for (int j = 1; j <= 8; j++) {
                ...
                TextView tx = new TextView(FiveActivity.this);
                tx.setId((i - 1) * 8 + j);
                //除了最后一列，都使用course_text_view_bg背景（最后一列没有右边框）
                if (j < 8)
                    tx.setBackgroundDrawable(FiveActivity.this.
                ...
                course.setOnClickListener(new View.OnClickListener() {
                   ...
                   @Override
                    public void onClick(View v) {
                        ...
                        AlertDialog alertDialog = new AlertDialog.Builder(FiveActivity.this).create();
                        alertDialog.show();
